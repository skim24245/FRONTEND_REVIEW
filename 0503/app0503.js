...
// let list=[1,2,3,4,5];
// let list2=list; 같은 값을 출력한다고 하더라도 둘한테 영향이 있다. 
...
// console.log(a+"+"+b+"="+(a+b)); 이렇게 쓰면 불편하니까 
// console.log (`${a}+${b}=${a+b}`);  이렇게 place order를 넣어서 동적으로 처리함.
// let now = new Date(); 자바스크립트에 내장 되어있는 api임. 우리가 선언 안해도 사용할 수 있다. 객체를 사용(선언)하려면 new를 써서 쓰면 된다. 
